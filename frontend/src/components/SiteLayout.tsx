// ================================================================
// FILE: src/components/layout/SiteLayout.tsx
// Shared layout: sticky header + footer + category nav
// ================================================================
...
export default function SiteLayout({ children, onRefresh }: SiteLayoutProps) {
  ...
  // Active category derived from URL path
  ...
  return (
    <div style={{
      minHeight: '100vh', background: TOKEN.bg,
      ...
      <header style={{ position: 'sticky', top: 0, zIndex: 30, background: TOKEN.white }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 20, flexShrink: 0 }}>
            <span style={{ fontFamily: FONT.mono, fontSize: 10, letterSpacing: '0.08em', color: '#C8B898' }}>
              {enDate}
            </span>
            <span style={{ fontFamily: FONT.deva, fontSize: 10, color: '#B8A882' }}>
              {bsDate.formatted}
            </span>
          </div>
        ...
        <div style={{
          ...
          >
            <div style={{
              fontFamily: FONT.serif, fontWeight: 900, fontSize: 58,
              letterSpacing: '-0.04em', color: TOKEN.ink, lineHeight: 0.88,
            }}>
      ...
      <footer style={{ background: TOKEN.dark }}>
        ...
        <div style={{
          ...
          <div>
            <div
              onClick={() => navigate('/')}
              style={{
                fontFamily: FONT.serif, fontWeight: 900, fontSize: 46,
                color: TOKEN.white, lineHeight: 0.88, letterSpacing: '-0.04em',
            ...
            {['acharyankit3@gmail.com', '9807345551', 'Kathmandu, Nepal'].map(c => (
              <div key={c} style={{ display: 'flex', alignItems: 'center', gap: 8, fontFamily: FONT.mono, fontSize: 11, color: 'rgba(255,255,255,.35)', letterSpacing: '0.04em', marginBottom: 6 }}>
          ...
          <div>
            ...
            {['Real Estate', 'Employment', 'Services', 'Matrimonial', 'Automobiles'].map(l => (
              <div
                ...
                style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 13, color: 'rgba(255,255,255,.3)', cursor: 'pointer', marginBottom: 9 }}
              >
            ...
            <div
              ...
              style={{ display: 'flex', alignItems: 'center', gap: 8, fontFamily: FONT.deva, fontSize: 13, color: 'rgba(255,255,255,.3)', cursor: 'pointer' }}
            >
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 10, padding: '16px 52px' }}>
          <div style={{ fontSize: 10, color: 'rgba(255,255,255,.18)', lineHeight: 1.6 }}>
            © {new Date().getFullYear()} Flyers. All advertisements independently placed. Subject to Nepal Advertisement (Regulation) Act 2076.
          </div>
